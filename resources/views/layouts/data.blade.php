...
<html>
	...
	$site_configurations = \DB::table('site_configurations')->where('status',1)->first();?>
        <title> 
        ...
        'unsafe-eval' *; style-src	'self' 'unsafe-inline' *; img-src 'self' blob: data:*;">
        ...
        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/bootstrap.min.css')) }}">
		
		<link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/material.min.css')) }}">
		<link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/material.min.css')) }}">
		
        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/font-awesome.min.css')) }}">
        
        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/app.css')) }}">
        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/styles.css')) }}">
        <link rel="stylesheet" href="{{ asset('css/v4-shims.css') }}">  

        @yield('additional_css')      

        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/custom.css')) }}">   
        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/custom2.css')) }}">
        <link rel="stylesheet" href="{{ SiteHelper::forceHttp(asset('css/responsive.css')) }}"> 

      
        <link media="all" rel="stylesheet" type="text/css" href="{{ SiteHelper::forceHttp(asset('css/site_theme.css')) }}">
        <script>
      ...
      <div id="layoutHeader" class="container-fluid app-wapper app-top-bar-container">
          <div class="app-top-bar align-items-center">
              <div class="row app-brand">
                    <!-- <a href="{{App\Helper\SiteHelper::forceHttps(route('home')) }}"> -->
                    <a href="{{route('home')}}">
        ...
        <div class="container footer_section1">
          <div class="row">
            <div class="col-md-4 col-lg-3">
              ...
              @php 
                ...
                @foreach ($allActiveCommunities as $key=>$comm) 
                  @php
                  $comm_slug = $comm->slug;
                  $route =  App\Helper\SiteHelper::forceHttps(route("data_community.$comm_slug"));
                  @endphp
            ...
            <div class="col-md-4 col-lg-3">
              ...
              <ul class="list-unstyled" data-turbolinks="false"> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.about')) }}">{{ trans('home.about_databroker') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.partners')) }}">{{ trans('home.partners') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.matchmaking')) }}">{{ trans('home.datamatch') }}</a></li>  
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.usecase')) }}">{{ trans('home.usecase') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.news')) }}">{{ trans('home.updates') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.media_center')) }}">{{ trans('home.media_center') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('contact')) }}">{{ trans('home.contact_us') }}</a></li> 
              </ul>
            </div>
            <div class="col-md-4 col-lg-3">
              <h5>{{ trans('home.helpsupport') }}</h5>
              <ul class="list-unstyled" data-turbolinks="false"> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('help.buying_data')) }}">{{ trans('home.buying_data') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('help.selling_data')) }}">{{ trans('home.selling_data') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('about.privacy_policy')) }}">{{ trans('home.privacy_security') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('help.guarantee')) }}">{{ trans('home.our_gurantee') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('help.file_complaint')) }}">{{ trans('home.file_complaint') }}</a></li> 
                <li><a href="{{ App\Helper\SiteHelper::forceHttps(route('help.feedback')) }}">{{ trans('home.give_feedback') }}</a></li>
              </ul>
            </div>
        ...
        <div class="container" id="footer-section-container">
          <div class="app-section app-footer-section align-items-center">
            <div class="app-footer-link col-md-12 col-lg-4">
                    ...
                    <a href="{{ App\Helper\SiteHelper::forceHttps(route('about.terms_conditions')) }}" target="_blank"> {{ trans('home.terms_conditions') }}</a>
                    <a href="{{ App\Helper\SiteHelper::forceHttps(route('about.privacy_policy')) }}" target="_blank"> {{ trans('home.privacy_policy') }}</a>
                    <a href="{{ App\Helper\SiteHelper::forceHttps(route('about.cookie_policy')) }}" style="padding-right: 0;" target="_blank">{{ trans('home.cookie_policy') }}</a>
                </div>
    ...
    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/core/jquery.min.js')) }}"></script>
    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/core/popper.min.js')) }}"></script>
    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/core/bootstrap.min.js')) }}"></script>    
    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/plugins/jquery.cookie.js')) }}"></script>    

    @yield('additional_javascript')

    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/app.js')) }}"></script>        
    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/custom.js')) }}"></script>   
    <script src="{{ App\Helper\SiteHelper::forceHttp(asset('js/custom2.js')) }}"></script>   
