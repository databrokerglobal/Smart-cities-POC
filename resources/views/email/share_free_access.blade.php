												...
												<tbody>
													...
													<tr>
														<td class="fs-18 lh-27 py-10">
															<b>{{$data['user']->firstname}} {{$data['user']->lastname}}</b> from <b>{{$data['companyName']}}</b>  has just invited you to acccess data products.
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<a href="{{url('/access_free_data')}}/{{$data['testshareIdx']}}" class="btn btn-primary">
																ACCESS NOW
															</a>
														</td>
													</tr>
