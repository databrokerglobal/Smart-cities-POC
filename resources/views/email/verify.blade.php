										...
										<td>
											<table class="mb-20" cellpadding="0" cellspacing="0" border="0">
												<tbody>
                                                    ...
                                                    <tr>
														<td class="fs-18 lh-27 py-10">
															If you did not created account, no further action is required.
														</td>
													</tr>
                                                    <tr>
														<td class="fs-12 lh-27 py-10">
															If you're having trouble clicking "Verify Email Address" button, copy and paste the URL below
                                                    ...
                                                    <tr>
														<td class="fs-18 lh-27 py-10">
															<b>Note : </b> This verification link will expires in next 60min.
														</td>
													</tr>
												</tbody>
											</table>
