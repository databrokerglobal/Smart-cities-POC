												...
												<tbody>
													...
													<tr>
														<td class="fs-18 lh-24 py-10">
															You can find the details of the sale in the <a href="{{ route('account.sales') }}">My sales</a> section of your account.
														</td>
													</tr>
												</tbody>
											</table>
													...
													<tr>
														<td class="fs-18 lh-24 py-10">
															<ul class="m-0">
																...
																<li class="py-10">During this time, {{APPLICATION_NAME}} holds your earnings related to this sale.</li>
