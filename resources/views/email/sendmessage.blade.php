										...
										<td>
											<table class="mb-20" cellpadding="0" cellspacing="0" border="0">
												<tbody>
													...
													<tr>
														<td class="fs-18 lh-24 py-10">
															In your {{APPLICATION_NAME}} account, simply go to the relevant data offer in <a href="{{route('data_offers_overview')}}">My data offers and products</a> and add or edit a data product.
														</td>
													</tr>
												</tbody>
											</table>
