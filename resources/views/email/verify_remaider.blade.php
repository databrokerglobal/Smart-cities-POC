										...
										<td>
											<table class="mb-20" cellpadding="0" cellspacing="0" border="0">
												<tbody>
													...
													<tr>
														<td class="fs-18 lh-27 py-10">
																To finish setting up your account on Databroker, please verify your email address.
														</td>
													</tr>
                                                    ...
                                                    <tr>
														<td class="fs-18 lh-27 py-10">
																If you didn’t make the request to create your account, you can ignore this email.
														</td>
													</tr>
													<tr>
													<td class="fs-18 lh-27 py-10">
																	<p>	Thanks,<br>
																			The Databroker team</p>																
														</td>
													</tr>
