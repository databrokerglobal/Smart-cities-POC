@include('content.head')
    <title> White paper | Databroker </title>
        ...
        <div class="col-md-12 top-box" >
            <div class="top-box-content">
                <h5> Commercial release, December 2020  </h5>
               

                <h1 class="title whitepaper-title">White paper</h1>
                <h3 class="sub-title">See how we utilize technology to enable decentralized data trading and data monetization, build 
                customized platforms for data rich organisations, and accelerate the data economy for everyone.</h3>   
            </div>            
        </div>
<div class="container">
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img class="side-img"  alt="Databroker white paper" title ="Databroker white paper"  
                    src="{{asset('images/content/white_paper.svg')}}" id="top-bar-img"/>                
            </div>
                <div class="col-md-5 col-12 get-it-form">
                    <h2 class="get-it-form-title">WHITE PAPER<h2>           
                    <script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script>
                        <script>
                        hbspt.forms.create({
                            region: "na1",
                            portalId: "8639589",
                            formId: "401bf12b-cd95-4964-9708-d904fe521328"
                        });
                    </script>  
                </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-12 get-it-form-container">               
                <h2 class="get-it-form-title get-it-form-title1">PREVIEW<h2>                
                <img style="width:100%" alt="Databroker white paper - the platform" title ="Databroker white paper - the platform" 
                src="{{asset('images/content/white-paper-preview.svg')}}"/>                
            </div>
        </div>
    </div>
    </div>
    <div class="message-section section css-17x4u48" >
        <p class="text-content drop-message1">Would you like to know more about Databroker?</p>
        <p class="text-content drop-message">Drop a message to <a href="mailto:vincent@databroker.global?subject=Know more about Databroker">vincent@databroker.global</a> or <a target="_blank" href="https://calendly.com/databroker/data-value?month=2020-09">book a time slot for a chat here</a>.</p>
    </div>
