...
<title> Smart Cities Survey Report | Databroker </title>
        ...
        <div class="col-md-12 top-box content-box " >
            <div class="top-box-content">
                <p>Survey Results</p>
                <h1 class="title">Most valuable data to smart cities</h1>
                <h3 class="sub-title">Databroker’s “Most Valuable Data to Smart Cities” survey was conducted in November 2020 and gained insights from smart city stakeholders in 11 countries on four continents.</h3>               
            </div>
        </div>
<div class="container">
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img class="side-img"  src="{{asset('images/content/smart_cities_survey_report.svg')}}" id="top-bar-img"/>
            </div>
            <div class="col-md-5 col-12 get-it-form">
            <h2 class="get-it-form-title"> SURVEY RESULTS</h2>
            <p>Strategic insights inside!</p>
            <script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script>
            <script>
                hbspt.forms.create({
                    region: "na1",
                    portalId: "8639589",
                    formId: "a06b2220-7fdd-4670-85e7-d4640ce83a90"
                });
            </script>
            </div>
            <div class="col-md-12 col-sm-6 reveal-points">               
                <p class="head">This survey reveals:</p>
                <ul>
                    <li><span>Which data sets smart city stakeholders want to drive the insights that make their cities smart. These data sets are broken by categories: Economics, People, Environment, Geographics, Transport, and Energy & Water consumption. </span></li>
                    <li>Real-world applications of data in the smart city context.</li>
                    <li>How cities, big and small, around the world are embarking on the smart city journey.</li>
                </ul>
    ...
    <div class="message-section section css-17x4u48" >
        ...
        <p class="text-content  drop-message1">We would be happy to share ideas for your smart city use case.</p>
