...
<title> IoT Platform | Databroker </title>
        ...
        <div class="col-md-12 top-box content-box " >
            <div class="top-box-content">
                <p>Minibook</p>
                <h1 class="title">What is the value of my data? - How IoT platforms can become data publishers and profit</h1>
                <h3 class="sub-title">Learn how to transition from a purely IoT supplier to a more data-driven business model, how to provide value add for your clients, and how to capture new markets.</h3>               
            </div>
        </div>
<div class="container">
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img class="side-img"  src="/images/content/iot_platforms.svg" id="top-bar-img"/>               
            </div>
            <div class="col-md-5 col-12 get-it-form">
            <h2 class="get-it-form-title">MINIBOOK<h2>
            <p>Use cases & strategic insights inside!</p>
            <script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script>
                <script>
               hbspt.forms.create({
                    region: "na1",
                    portalId: "8639589",
                    formId: "1f8dd8e3-5eee-4c72-8768-a2983baadf5d"
                });
                </script>  
            </div>
            <div class="col-md-12 col-sm-6 reveal-points">               
                <p class="head">This minibook summarizes findings and insights across a range of industries through real-world use cases. It reveals:</p>
                <ul>
                    <li>The key features of data. Why some data can be used, again and again, without losing its value while other data has little or no value.</li>
                    <li>How to help your clients to leverage data that you are already collecting. Understand the value of data from three perspectives: individuals, society, and businesses.</li>
                    <li>How data trading fits into your client's business model. Discover ways to redesign your offering, differentiate your organization and profit. </li>
                </ul>
    ...
    <div class="message-section section css-17x4u48" >
        <p class="text-content drop-message1">Want to discuss the value of your data that you are already collecting?</p>
        <p class="text-content drop-message1">We would be happy to share ideas for your use case.</p>
        <p class="text-content drop-message">Drop a message to <a href="mailto:vincent@databroker.global?subject=Let’s discuss the value of your data">vincent@databroker.global</a> or <a target="_blank" href="https://calendly.com/databroker/data-value?month=2020-09">book a time slot for a chat here</a>.</p>
    </div>
    <div class="section-arrow section css-17x4u48" >
      
            <a href="#" class='text-center'>© Databroker</a>
            <a href="{{route('about.terms_conditions')}}" target = "_blank" class='text-center'>Terms and Conditions</a>
            <a href="{{route('about.privacy_policy')}}"  target = "_blank" class='text-center'>Privacy Policy</a>
            <a href="{{route('about.cookie_policy')}}"  target = "_blank" class='text-center'>Cookie Policy</a>
    </div>   
