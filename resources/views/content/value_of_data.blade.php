...
<title> Value of Data | Databroker </title>
        ...
        <div class="col-md-12 top-box content-box " >
            <div class="top-box-content">
                <p>Minibook</p>
                <h1 class="title">What is the value of my data? - How big and small businesses can become data providers and profit</h1>
                <h3 class="sub-title">How organizations are leveraging data to inform decision making, streamline operations, provide value add, and capture new markets.</h3>               
            </div>
        </div>
<div class="container">
    <div class="content">        
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img class="side-img"  src="{{asset('images/content/value_of_data.svg')}}" id="top-bar-img"/>
            </div>
            ...
            <script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script>
                <script>
                    hbspt.forms.create({
                        region: "na1",
                        portalId: "8639589",
                        formId: "c2c824fe-a789-431d-af1f-2cd6253a2f2c"
                    });
                </script>  
            </div>
            <div class="col-md-12 col-sm-6 reveal-points">               
                ...
                <ul>
                    <li><span>The key features of data. Why some data can be used, again and again, without losing its value while other data has little or no value.</span></li>
                    <li>How to help you or your clients to leverage data that you are already collecting. Understand the value of data from three perspectives: individuals, society, and businesses.</li>
    ...
    <div class="message-section section css-17x4u48" >
        <p class="text-content  drop-message1">Want to discuss the value of your data?</p>   
