...
<title> Databroker use cases of satellite data in agriculture | Databroker </title>
        <div class="row logo-section">   
           
            <a href="{{route('home')}}"><svg id="logo-black" xmlns="http://www.w3.org/2000/svg" width="525.314" height="90.848" viewBox="0 0 525.314 90.848">
        ...
        <div class="col-md-12 top-box " >
            <div class="top-box-content">
                <p>Use cases</p>
                <h1 class="title">How satellite imagery data is applied in agriculture</h1>
                <h3 class="sub-title">The growing potential and use cases of geo-spatial satellite data in the agriculture sector.</h3>               
            </div>
        </div>
<div class="container">
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img class="side-img"  src="{{asset('images/content/satellite_data_for_agriculture.png')}}" id="top-bar-img"/>
                
            </div>
            <div class="col-md-5 col-12 get-it-form">
            <h2 class="get-it-form-title"> USE CASE GUIDE</h2>
            ...
            hbspt.forms.create({
                region: "na1",
                portalId: "8639589",
                formId: "4e71d908-a266-44e8-9190-481defd51ac7"
            });
            </script> 
            </div>
            <div class="col-md-12 col-sm-6 reveal-points">               
                <p class="head">This use case guide reveals:</p>
                <ul>
                    <li>How farmers, insurance providers, and companies engaged in manufacturing agro products can leverage geo-spatial satellite data to increase overall efficiency and profitability.</li>
                    <li>Why satellite imagery data have value to authorities to understand and improve food security and enhance wellbeing.</li>
                    <li>How satellite imagery can reduce environmental impact and bolster sustainability measures. </li>
                </ul>
    ...
    <div class="message-section section css-17x4u48" >
        ...
        <p class="text-content drop-message">Drop a message to <a href="mailto:vincent@databroker.global?subject=Let’s discuss the value of your data">vincent@databroker.global
        </a> or <a target="_blank" href="https://calendly.com/databroker/data-value?month=2020-09">book a time slot for a chat here</a>.</p>
    </div>
