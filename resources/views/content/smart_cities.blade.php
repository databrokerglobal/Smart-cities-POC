...
<title> Smart Cities | Databroker </title>
        ...
        <div class="col-md-12 top-box " >
            <div class="top-box-content">
                <p>Use cases</p>
                <h1 class="title">The growing value of human behavioural data</h1>
                <h3 class="sub-title">How city planners, retailers, governments, and law enforcement can leverage data to inform decision making.</h3>               
            </div>
        </div>
<div class="container">
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                <img class="side-img"  src="{{asset('images/content/smart_cities.svg')}}" id="top-bar-img"/>
            ...
            <script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script>
                ...
                hbspt.forms.create({
                    region: "na1",
                    portalId: "8639589",
                    formId: "7e20ae36-f99c-41c5-ae78-d22988220303"
                });
                </script>  
            </div>
            <div class="col-md-12 col-sm-6 reveal-points">               
                ...
                <ul>
                    <li>Where human behavioural data fit into the larger data ecosystem of smart cities.</li>
                    <li>Why human behavioural data have value and provide insight into things like how infectious diseases spread, why traffic jams happen, where the ideal location for a new store is.</li>
                    <li>How cities can capitalize on the growing value of human behavioural data and create smart cities of the future. </li>
                </ul>
