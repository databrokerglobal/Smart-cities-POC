        ...
        <div class="row justify-content-center mt-30 auth-section">        
            <div class="col-md-8">
                ...
                <p class="text-center fs-16"> 
                    Want to know more about our DataMatch service? About becoming a partner?
                     Or maybe you didn’t find the answer to your questions in our 
                     <a href="{{route('help.overview')}}">Help & support centre</a> or 
                     <a href="{{route('about.media_center')}}">Media centre?</a><br/><br/>
               ...
               <!--[if lte IE 8]>
                ...
                hbspt.forms.create({
                    region: "na1",
                    portalId: "8639589",
                    formId: "52d9a5e0-877d-4271-a73a-61f2ce834074"
                });
                </script>
            </div>
        </div>
