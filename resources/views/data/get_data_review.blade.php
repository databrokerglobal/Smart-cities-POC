...
<div class="container-fluid app-wapper data-offer">
    ...
    <div class="container">
    	<form method="post" action="{{ route('data.take_data', ['id'=>$product->offerIdx, 'pid'=>$product->productIdx]) }}">
			...
			<input type="hidden" id="ppmid" name="ppmid" value="{{$ppmapping->ppmIdx}}">
			<input type="hidden" id="productAccessDays" name="productAccessDays" value="{{$ppmapping->productAccessDays}}">
