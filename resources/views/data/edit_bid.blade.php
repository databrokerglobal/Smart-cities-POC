    ...
    <div class="container">
    	<div class="app-section app-reveal-section align-items-center">    		
	        ...
	        <div class="blog-content">
	        	...
	        	@else
	        		<span class="text-red">€ {{$ppmapping->productPrice?$ppmapping->productPrice :'NA'}}</span>
	        	@endif
	        	</div>
	        	<div class="para">
	        		...
	        		<div class="col-md-6 auth-section">
	        			<form method="POST" action="{{route('data.update_bid', ['bid'=>$bid->bidIdx])}}">
		        			...
		        			<label class="pure-material-textfield-outlined currency-input">
		                        ...
		                        <input type="number" id="bidPrice" step="1" min='1' max="999999999" placeholder="1.00" name="bidPrice" class="form-control input_data price_input @error('bidPrice') is-invalid @enderror" placeholder=" "  value="{{ old('bidPrice', $bid->bidPrice) }}" autofocus>
