...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	...
	<div class="m-subheader ">
		<div class="d-flex align-items-center">
			<div class="mr-auto">
				<h3 class="m-subheader__title m-subheader__title--separator"><b style="color: #9102f7;">{{ $communityNameLabel }}</b> Edit Article</h3>
	...
	<div class="m-content">
		...
		<div class="col-sm-12 text-right">
			...
			<form class="m-form m-form--fit m-form--label-align-right" id="board_form" novalidate="novalidate" enctype="multipart/form-data">
				...
				<input type="hidden" id="redirectFrom" name="redirectFrom" value="{{ $redirectFrom??'' }}">
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						<div class="col-md-7 m-form__group-sub">
							...
							<input type="text" class="form-control m-input character-count" id="articleTitle" name="articleTitle" placeholder="Enter article title" value="{{ $board->articleTitle??'' }}"  maxlength="250" onkeyup="convertString('articleTitle', 'slug')">
						...
						<div class="col-md-2 m-form__group-sub">
							...
							<input type="text" class="form-control m-input" name="published" placeholder="DD/MM/YYYY" readonly="readonly" value="{{ $board->published? date('d/m/Y', strtotime($board->published)): '' }}" autocomplete="off">
						</div>
					...
					<div class="m-form__actions m-form__actions">
						<div class="row">
							<div class="col-lg-9 ml-lg-auto">
								...
								@if(isset($redirectFrom) && $redirectFrom != "")
								<a href="{{ route('admin.top_use_cases') }}" class="btn btn-secondary">Cancel</a>
								@else
