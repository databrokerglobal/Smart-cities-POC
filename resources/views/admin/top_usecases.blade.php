...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator"><b style="color: #9102f7;">Home</b>Top Use Cases</h3>
            </div>
        </div>
    </div>
    <!-- END: Subheader -->
                        ...
                        <tbody>
                            @foreach($boards as $board)                      
                                <tr>
                                    ...
                                    <td>
                                    <a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill activeCl"           onclick="promote_record('{{$board->articleIdx }}',0);" title="Click to remove from top use cases">
                                    ...
                                    <a href="{{ route('admin.usecases_edit',[$board->articleIdx,'top-use-case']) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">
