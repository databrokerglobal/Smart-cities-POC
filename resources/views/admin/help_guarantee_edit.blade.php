			...
			<div class="mr-auto">
				...
				<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    <li class="m-nav__item m-nav__item--home">
                        <a href="{{ route('admin.help.guarantee') }}" class="m-nav__link m-nav__link--icon">
				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						<div class="col-md-12 m-form__group-sub">
							...
							<textarea class="form-control m-input" id="editor"  rows="5" name="description" placeholder="Enter description">{{ isset($topic)? $topic->description : '' }}</textarea>
						</div>
					</div>
				</div>
