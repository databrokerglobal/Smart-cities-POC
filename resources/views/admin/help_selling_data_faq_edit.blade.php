			...
			<div class="mr-auto">
				...
				<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    <li class="m-nav__item m-nav__item--home">
                        <a href="{{ route('admin.help.selling_data_faqs') }}" class="m-nav__link m-nav__link--icon">
				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						<div class="col-md-6 m-form__group-sub">
							<label class="form-control-label">FAQ </label> <span class="red">*</span>
							<input type="text" class="form-control m-input character-count" name="faq" placeholder="Enter FAQ" value="{{ isset($faq)? $faq->faq: '' }}" maxlength="250">
					...
					<div class="form-group m-form__group row">
						<div class="col-md-12 m-form__group-sub">
							...
							<textarea class="form-control m-input" id="editor"  rows="5" name="description" placeholder="Enter FAQ description">{{ isset($faq)? $faq->description : '' }}</textarea>
						</div>
					</div>
				</div>
