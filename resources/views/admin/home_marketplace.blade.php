                        ...
                        <tbody>
                            @foreach($boards as $board)                      
                                <tr>
                                    ...
                                    <td align="center">
                                        @if(!empty($board->image) && file_exists(public_path("uploads/home/marketplace/logo/thumb/".$board->logo))) 
                                            {{ asset("uploads/home/marketplace/logo/thumb/".$board->logo) }}
                                        @else 
                                            {{ asset('uploads/company/thumb/default.png') }}
                                        @endif
                                    </td>
                                    <td class="word-break">{{ $board->title }}</td>
                                    <td>{{ $board->order }}</td>
                                    ...
                                    <td> 
                                        ...
                                        @endif 
                                        <a href="{{route('admin.home_marketplace_edit',$board->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">
