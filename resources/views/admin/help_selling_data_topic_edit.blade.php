			...
			<div class="mr-auto">
				...
				<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    <li class="m-nav__item m-nav__item--home">
                        <a href="{{ route('admin.help.selling_data_topics') }}" class="m-nav__link m-nav__link--icon">
				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						<div class="col-md-6 m-form__group-sub">
							<label class="form-control-label">Topic Title </label> <span class="red">*</span>
							...
							<select class="form-control m-input" name="active">
								@if(isset($statusList) && count($statusList)>0)
									@foreach($statusList as $statusKey=>$statusValue)
										@if( isset($topic) && $statusKey == $topic->active)
					...
					<div class="form-group m-form__group row">
						<div class="col-md-12 m-form__group-sub">
							<label for="exampleTextarea">Topic Description</label> <span class="red">*</span>
							<textarea class="form-control m-input"  id="editor" rows="5" name="description" placeholder="Enter topic description">{{ isset($topic)? $topic->description : '' }}</textarea>
						</div>
					</div>
				</div>
