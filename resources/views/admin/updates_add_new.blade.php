				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-md-3 m-form__group-sub">
							...
							<input type="text" class="form-control m-input" readonly name="published" placeholder="DD/MM/YYYY" value="" autocomplete="off">
                        </div>
                        <div class="col-md-3 m-form__group-sub">
							<label class="form-control-label">Author </label> <span class="red">*</span>
							<input type="text" class="form-control m-input character-count" name="author" placeholder="Enter article author" value="" maxlength="50">
