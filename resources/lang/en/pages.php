...
return [
    ...
    */
    ...
    'profile_description' => 'You can deactivate your '.APPLICATION_NAME.' account anytime you want.',
    ...
    'SHARE_OFFER' => 'SHARE PRIVATELY',
    'SHARE_OFFER_MODEL_HEADING' => 'An email will be sent to these recipients, inviting them to access this offer',
    'Data_Type' => 'Type',
    ...
    'publish_data_offer_desc' => 'You’re in the right place! Businesses around the world – from small and medium-sized enterprises to multinationals – are understanding the need to put data at the heart of their strategic decision-making. Could your data be just what they need?
    
    <br/><br/>Our mission is to connect those who have data with those who need it and appreciate its value. And the Databroker marketplace does just that.
    <br/><br/>Publishing a data offer on our marketplace is the perfect way to attract potential buyers, and then discover how you can meet their specific needs.
    <br/><br/> What’s more, it’s easy and free!',
    ...
    'advantage_databroker_reason2_desc' => "From the moment you publish your data offer in our marketplace, to the moment you receive your earnings in your account, all aspects of the transaction are automated and handled within ".APPLICATION_NAME.". 
    <br><br>No separate contracts or agreements to keep track of, and after the 30-day warranty period, you can redeem your earnings at the touch of a button.",
    'advantage_databroker_reason3' => 'Fully secure peer-to-peer data transfer',
    'advantage_databroker_reason3_desc' => 'Our marketplace is all about bringing together buyers and sellers, and thanks to our peer-to-peer marketplace, the data you sell is transferred directly from your system to the buyer, never passing through the '.APPLICATION_NAME.' platform. 
    <br><br>This means you keep full control of your data at all times, and that only buyers have access to the specific data product(s) they have bought.',

    'overview' => 'Overview',
    'features_capacities' => 'Features & Capacites',
    'faq' => 'FAQ',
    'tech_support' => 'Tech Support',

    /* data users and private sdata sharings */
    'MY_DATA_USERS_TITLE' => 'My data users',
    'MY_DATA_USERS_PAGE_CONTENT'        => 'The organizations and users below have access to your data products.',
    'NEW_ORGANIZATION'    => 'New Organization',

    /* data users and private sdata sharings */
    'MY_DATA_PROVIDERS_TITLE' => 'My data providers',
    'MY_DATA_PROVIDERS_PAGE_CONTENT'        => 'You have access to the data products from the data providers below.',
    'warranty_more_info' => ''.APPLICATION_NAME.' offers a 30-day warranty on all data purchased. In the event of problems with data you purchase, you can file a complaint before the end of the warranty period.',
    'category_community_for_about' => 'community for data about',
    'provider_title' => 'Easy download data from :provider on databroker'
