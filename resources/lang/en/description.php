...
return [
    ...
    */
    ...
    'Chemicals_intro' => 'Chemical Studies include chemical, pharmaceutical and biomedical review and research studies.',
    'Regulations_intro' => 'The regulation of chemicals is the legislative intent of a variety of national laws or international initiatives.',
    'Study_Type_intro' => 'Study Type Introduction.',
    ...
    'Chemicals_overview' => 'Chemical Studies include chemical, pharmaceutical and biomedical review and research studies and cover: Organic Chemistry, Physical Chemistry, Analytical Chemistry, Polymer Sciences, Medicinal Chemistry, Natural Chemistry, Biochemistry, Analytical Research Works, QSAR Studies, Nanotechnology, Biotechnological Research Works, Method and Process Development, Drug Development etc.',
    'Regulations_overview' => 'The regulation of chemicals is the legislative intent of a variety of national laws or international initiatives such as agreements, strategies or conventions. These international initiatives define the policy of further regulations to be implemented locally as well as exposure or emission limits.',
    'Study_Type_overview' => 'Study Type Overview.',
    ...
    'product_pricing_tooptip' => 'When you sell data, '.APPLICATION_NAME.' charges a transaction fee of 10% of the sale price. This means that, at the end of the 30-day warranty period we credit your wallet with the earnings, minus the 10% transaction fee.',
    ...
    'product_type_tooptip' => '<strong>Publicly : </strong>Your data product is displayed in the market place and can be ordered by any one .<br> <strong>Privatly : </strong>Your data prodcut can be only by users you have created in the "My data users" section.',
];
