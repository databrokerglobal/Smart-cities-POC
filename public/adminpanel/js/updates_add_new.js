$(function(){
	...
	$( "#board_form" ).validate({
	    ...
	    rules: {
            ...
            category1 : {
                required: function(element) {
                    return $("#article-category").val() === 'Other';
                  }
            },
	    },
	    ...
	    submitHandler: function (form) {
	    	...
	    	$.ajax(
                    {
                        url: WEBSITE_URL+"/admin/updates/update", 
                        type: "POST",
    ...
    $("#input-file").change(function(e){
        ...
        // AJAX request
        $.ajax({
            url: WEBSITE_URL+'/admin/updates/summernote/upload_attach', 
            type: 'post',
            data: form_data,
            dataType: 'json',
            contentType: false,
            ...
            success: function (response) {
                if(response.success){
                    ...
                    {
                        node.innerHTML += "<a href='"+WEBSITE_URL+"/adminpanel/uploads/updates/"+names[i]+"' target='_blank' download='"+names[i]+"'>"+
