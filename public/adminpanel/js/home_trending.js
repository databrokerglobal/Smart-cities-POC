        ...
        var settings = {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    // render: function(data, type, full, meta) {
                    //     return `
                    //         <a href="`+WEBSITE_URL+`/admin/home_trending/edit/`+data+`" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">
...
function publish_record(record_idx){
    $.ajax({
      ...
      url: WEBSITE_URL+'/admin/home_trending/publish',
      data: {id: record_idx},
      method: 'post',
...
$("#upload_attach").change(function(event){
    ...
    $.ajax({
        ...
        url: WEBSITE_URL+"/admin/home_trending/upload_attach/" + attach_record_idx,
        type: 'POST',
        data: data,
        contentType: false,
        processData: false,
