            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<a href="'+WEBSITE_URL+'/admin/help/selling_data/topic/edit/' + data + '" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">'
  ...
  function(isConfirm) {
    if (isConfirm) {
      $.ajax({
        ...
        url: WEBSITE_URL+'/admin/help/selling_data/topic/delete/'+record_idx,
        method: 'get',
