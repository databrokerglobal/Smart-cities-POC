            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<a href="'+WEBSITE_URL+'/admin/help/feedbacks/edit/' + data + '" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Update">'
  ...
  function(isConfirm) {
    if (isConfirm) {
      $.ajax({
        ...
        url: WEBSITE_URL+'/admin/help/feedbacks/delete/'+record_idx,
        method: 'get',
        success: function(res){
          if(res=="success"){
            window.location.href= WEBSITE_URL+"/admin/help/feedbacks";
          }
        }
      });
    }else 
