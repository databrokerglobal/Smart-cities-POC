...
function publish_record(record_idx){
  $.ajax({
    ...
    url: WEBSITE_URL+'/admin/partners/publish',
    data: {id: record_idx},
    method: 'post',
...
function make_proud_record(record_idx){
  $.ajax({
    headers: {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    },
    url: WEBSITE_URL+'/admin/partners/proud-partner',
    data: {id: record_idx},
    method: 'post',
    success: function(res){
     window.location.href= WEBSITE_URL+"/admin/partners";
  ...
  function(isConfirm) {
    if (isConfirm) {
      $.ajax({
        ...
        url: WEBSITE_URL+'/admin/partners/delete/'+record_idx,
        method: 'post',
        success: function(res){
            window.location.href= WEBSITE_URL+"/admin/partners";
